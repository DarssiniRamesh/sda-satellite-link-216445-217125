...
def create_app() -> FastAPI:
    ...
    Returns:
        FastAPI: Configured FastAPI application instance with metadata and middleware.
    """
    app = FastAPI(
        ...
        description=(
            ...
            "ARQ management for the SDA Satellite Link system. This service exposes health "
            "and future protocol processing endpoints for internal use by other containers."
        ),
        version="0.1.0",
        openapi_tags=[
            {
                "name": "health",
                "description": "Basic service health and readiness endpoints.",
            },
            {
                "name": "protocol",
                "description": "Protocol processing and coding interfaces (future).",
            },
        ],
    )
